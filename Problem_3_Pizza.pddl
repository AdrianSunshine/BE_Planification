(define (problem prob3)
 ...
 (:objects
     pizza1 pizza2 pizza3 pizza4 pizza5 pizza6 - pizza
 ...
 (:goal
  (and
     (filled pizza1 tre_formaggi)
     (filled pizza2 regina)
     (filled pizza3 siciliana)
     (filled pizza4 completa)
     (filled pizza5 regina)
     (filled pizza6 siciliana)
